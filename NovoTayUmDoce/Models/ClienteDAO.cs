...
namespace NovoTayUmDoce.Models
{
    class ClienteDAO
    {
        ...
        public void Delete(Cliente cliente)
        {
            ...
            {
                MessageBox.Show($"Erro ao excluir cliente: {e.Message}");
            }
            finally
            {
                conn.Close();
        ...
        public void Update(Cliente cliente)
        {
            try
            {
                ...
                var query = conn.Query();
                query.CommandText = "UPDATE Cliente SET nome_cli = @nome, cpf_cli = @cpf, data_nascimento_cli = @data_nasc, " +
                                     "contato_cli = @contato, id_end_fk = @enderecoId WHERE id_cli = @id";
            ...
            {
                MessageBox.Show($"Erro ao atualizar cliente: {e.Message}");
                throw;
            }
            finally
            {
        ...
        public Cliente GetById(int id)
        {
            ...
            {
                MessageBox.Show($"Erro ao obter cliente por ID: {e.Message}");
                return null;
            }
            finally
            {
