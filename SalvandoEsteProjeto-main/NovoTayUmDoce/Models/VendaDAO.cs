    ...
    class VendaDAO
    {
        ...
        public void Insert(Venda venda)
        {
            try
            {
                ...
                query.CommandText = $"INSERT INTO Venda(valor_ven, forma_pagamento_ven, data_hora_ven, desconto_ven, id_cli_fk, id_fun_fk) " +
                    $"VALUES (@valor, @forma_pagamento, @data_hora, @desconto, @id_cli, @id_fun)";

                query.Parameters.AddWithValue("@valor", venda.Valor);
                query.Parameters.AddWithValue("@forma_pagamento", venda.Forma_pagamento);
                query.Parameters.AddWithValue("@data_hora", venda.Data?.ToString("yyyy-MM-dd"));
